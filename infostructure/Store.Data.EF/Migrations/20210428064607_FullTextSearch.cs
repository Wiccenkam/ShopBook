...
namespace Store.Data.EF.Migrations
{
    public partial class FullTextSearch : Migration
    {
        ...
        {
            migrationBuilder.Sql("CREATE FULLTEXT CATALOG StoreFullTextCatalogg AS DEFAULT", suppressTransaction:true);
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("DROP FULLTEXT CATALOG StoreFullTextCatalogg", suppressTransaction: true);
        }
    }
}
